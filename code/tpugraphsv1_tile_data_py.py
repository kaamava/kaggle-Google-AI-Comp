...
# 
# https://github.com/google-research-datasets/tpu_graphs/blob/main/tpu_graphs/baselines/tiles/data.py
...
def get_npz_split(
    split_path: str, min_configs=2, cache_dir=None) :
